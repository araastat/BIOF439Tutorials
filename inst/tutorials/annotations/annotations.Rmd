...
The following code uses the `factor` function to explicitly reset the labels, and updates the plot just by updating
the data element of the `plt` object. 


Change the code for data transformation to use pipes and functions from the **forcats** package. 
